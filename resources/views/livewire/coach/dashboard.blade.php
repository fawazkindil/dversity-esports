    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
                    <h2>WELCOME COACH!</h2>
                    <p>  Welcome to D'Versity eSports,<br> We are a humble growing community/Organization of people.<br>
                        If you're interested do contact us to know more, don't forget to follow us on Facebook.<br>
                        <p class = "mt-6">"D'Versity's main objective is to create a POSITIVE community for those who
                        simply have passion and
                        enjoy to play games."</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="best_main">
                    <div class="row d_flex">
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                            <div class="best_text">
                                <p>A reader will be distracted by the readable content of a page when looking at its
                                    layout. The point of using LoremIt is a long established fact that a reader will be
                ...
                <div class="best_main pa_bot">
                    <div class="row d_flex">
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                            <div class="best_text">
                                <p>D'versity eSports Recruitment
                                    We are currently looking for more player to join us
                                    Requirements :<br>
                                    -Willing to join as many tournaments &training as possible in 2021<br>
                                    -18 years old or above (Mature, looking for professional exposure)<br>
                                    -Live in the South East Asia<br>
                                    -Dedicated players<br>
                                    -previous Acts Platinum II or above<br>
                                    -English Spoken<br></p>
                                {{-- <a href="#">See More</a> --}}
                            </div>
                        </div>
